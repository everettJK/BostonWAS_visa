...
if(file.exists('data.RData')){
  ...
  save(intSites, sampleData, file = 'data2.RData', compress = 'bzip2', compression_level = 9)          
}

intSites <- data.frame(intSites)
intSites <- filter(intSites, cellType %in% c("PBMC", "T cells", "Neutrophils", "NK cells", "B cells"))
```
